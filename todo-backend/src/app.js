...
(0, typeorm_1.createConnection)().then(function (db) {
    var todoRepository = db.getRepository(Todo_1.Todo);
        ...
        conn.createChannel(function (err1, channel) {
            ...
            app.post('/api/todos', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            todo = todoRepository.create(req.body);
            ...
            app.get('/api/todos/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, todoRepository.findOne({ where: { id: +req.params.id } })];
                        case 1:
                            todo = _a.sent();
                            res.send(todo);
                            return [2 /*return*/];
            ...
            app.delete('/api/todos/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, todoRepository.delete({ id: +req.params.id })];
                        case 1:
                            result = _a.sent();
